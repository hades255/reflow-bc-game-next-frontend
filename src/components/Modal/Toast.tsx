...
import { closeToast } from "@/redux/slices/main/toastSlice";
...
const Toast: FC<Props> = ({ type, message }) => {
  ...
  return (
    <div
      className="max-w-xs min-w-48 border fixed right-6 bottom-6 !animate-toast-animation rounded-lg shadow-lg bg-neutral-800 border-neutral-700"
      role="alert"
    >
