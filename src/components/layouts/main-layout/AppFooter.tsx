...
const AppFooter: FC = () => {
  return (
    <footer className="w-full p-12 text-[#5D5D5D]">
      <div className="p-6 flex justify-between min-h-max mobile:flex-col mobile:gap-[20px] mobile:px-[20px] mobile:py-[30px] mobile:mb-[26px] rounded-lg innerBlack">
        <div className="flex justify-between md:gap-[57px] gap-[30px] mobile:flex-col mobile:gap-[15px] mobile:justify-start mobile:items-center">
          <div className="flex flex-col gap-[12px] max-w-[300px] mobile:max-w-full mobile:w-full mobile:items-center items-start">
            ...
            <div className="hidden flex-col gap-[20px] max-w-[320px] mobile:w-full">
              ...
              >
                <div className="w-[160px] flex justify-center items-center text-xl gap-[8px] p-[10px] bg-raisin-black rounded-[8px] text-white">
          ...
          <div className="flex flex-col gap-[20px] max-w-[320px] mobile:w-full">
            <div className="max-w-[520px] text-xs leading-[18px] text-md mobile:w-full mobile:text-center">
              At Reflow, we{"’"}re committed to providing the fairest and most
              thrilling gaming experience, featuring the industry{"’"}s best
              house edge. Join us today and play with confidence, knowing that
        ...
        <div className="flex justify-between md:gap-[90px] gap-[30px] ml-[10px] mobile:flex-wrap mobile:gap-[20px]">
          ...
          <div className="flex flex-col gap-[10px] mobile:w-[_40%] mobile:items-start">
            ...
            <div className="footer_languageSwitcher__rUqv_ flex mobile:hidden flex-col gap-[0px] w-full h-[80px]">
              ...
              <div
                ...
                rel="noopener noreferrer"
              >
                <div className="flex justify-center items-center text-[14px] text-xl gap-[5px] p-[10px] bg-raisin-black rounded-[8px] text-white">
                  <SupportImg color="white" />
          ...
          <div className="footer_languageSwitcher__rUqv_ hidden mobile:flex flex-col gap-[0px] h-[80px]">
            <div className="language_short__bH9Qg !justify-start !items-start group/active hover: cursor-pointer w-full h-full flex transition duration-300 text-xl gap-[5px] text-white relative">
              <div className="z-10 !top-[25px] !left-0 !min-w-[40px] !w-[90px] language_bottom__mbDSA bg-dark-charcoal flex flex-col gap-[15px] p-[10px] undefined invisible">
                <div className="group flex items-center gap-[10px] cursor-pointer">
                  <Image
                    ...
                    alt="logo"
                  />
                  <span className="group-hover:text-aztec-gold text-white transition duration-300 select-none text-sm">
                    ENG
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-[10px]">
                <Image src={ukIcon} className="w-[12px] h-[12px]" alt="logo" />
                <span className="text-white select-none text-sm">ENG</span>
              </div>
          ...
          <div className="mobile:flex hidden items-center gap-[10px] mt-[-40px]">
            <div>
              <div className="w-9 h-9 rounded-[18px] bg-gray-600 flex justify-center items-center text-white">
                18+
              </div>
