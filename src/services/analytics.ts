...
export const withdrawGetPending = async (params: any) => {
  const data = await fetchAPI(
    "/api/admin/withdraw/get-pending",
    "POST",
    params
  );
  return data;
...
export const withdrawApprove = async (params: any) => {
  const data = await fetchAPI("/api/admin/withdraw/approve", "POST", params);
  return data;
};
